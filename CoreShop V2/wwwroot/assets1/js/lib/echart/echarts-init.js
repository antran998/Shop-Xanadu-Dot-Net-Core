$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function (data) {
            var time = data.time;
            var sale = data.totalsale;
            var actualSale = data.actualsale;

            TotalSale(time, sale, actualSale);
        }
    });

    function TotalSale(time,sale,actualSale) {
        ...
        option = {
            ...
            legend: {
                data: ['Sale', 'Actual Sale']
            },
            calculable: true,
            xAxis: [
                {
                    type: 'category',
                    //data: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']  /// Ngay thang
                    data:time
                }
            ],
            yAxis: [
            ...
            series: [
                {
                    name: 'Sale',
                    type: 'bar',
                    //data: [2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20.0, 6.4, 3.3], // Data sale
                    data: sale
                    //markPoint : {
                    //    data : [
                    //        {type : 'max', name: 'Max'},
                ...
                },
                {
                    name: 'Actual Sale',
                    type: 'bar',
                    //data: [2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3], // Data actual sale
                    data: actualSale
                    //markPoint : {
                    //    data : [
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            CatagorySale(color, legend, saleCate);
        }
    });
    
    //--Basic Pie echarts init-->
    function CatagorySale(color, legend, saleCate) {
        ...
        option = null;
        option = {
            //color: ['#62549a', '#4aa9e9', '#ff6c60', '#eac459', '#25c3b2'], // màu
            color: color,
            tooltip: {
                trigger: 'item',
            ...
            legend: {
                orient: 'vertical',
                x: 'left',
                //data: ['Direct', 'Mail', 'Affiliate', 'AD', 'Search'] // loại
                data: legend
            },
            calculable: true,
            series: [
